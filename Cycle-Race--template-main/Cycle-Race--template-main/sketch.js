...
function setup()
{
  ...
  Gameov.addImage(" ytttttttt",over)
...
function riding()
{
  if(frameCount%90==0)
  {
    ...
    switch(sand)
    {
      ...
      break
      case 2 : ope.addImage(op1)
      break
      case 3 : ope.addImage(op2)
      break
      case 4 : ope.addImage(op3)
      break
      case 5 : ope.addImage(op4)
      break
      case 6 : ope.addImage(op5)
      break
      default:
        break
    }
